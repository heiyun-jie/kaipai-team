...
const ACTION_META: PermissionMeta[] = [
  ...
  { code: 'action.referral.policy.create', label: '创建邀请规则', category: 'action', moduleKey: 'referral' },
  { code: 'action.referral.policy.edit', label: '编辑邀请规则', category: 'action', moduleKey: 'referral' },
  { code: 'action.referral.policy.enable', label: '启用邀请规则', category: 'action', moduleKey: 'referral' },
  { code: 'action.referral.policy.disable', label: '停用邀请规则', category: 'action', moduleKey: 'referral' },
