# Login Auth Mini Program Page Evidence 20260404-024533-continue-login-auth-mini-program-page-evidence-rerun

- Generated At: `2026-04-03T18:46:17.137Z`
...
- `login-page-invite` -> path=`pages/login/index` query=`{"inviteCode": "SMK100"}` screenshot=`login-page-invite.png` method=`automator` pageData=`page-data-login-page-invite.json`
