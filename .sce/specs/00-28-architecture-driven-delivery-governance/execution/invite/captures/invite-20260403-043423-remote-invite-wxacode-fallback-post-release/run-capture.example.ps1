...
powershell -ExecutionPolicy Bypass -File `
  ...
  -GrantId "2" `
  -PolicyId "1" `
  -OutputDir "D:\XM\kaipai-team\.sce\specs\00-28-architecture-driven-delivery-governance\execution\invite\captures\invite-20260403-043423-remote-invite-wxacode-fallback-post-release"
