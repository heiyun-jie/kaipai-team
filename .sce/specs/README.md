...
| 00-201 | current-phase-miniapp-home-ai-first-simplification | 当前阶段小程序首页 AI 优先简化与阴阳鱼双入口：删除手动风格网格、统计条与重型指南；`480rpx` 显著高度调整、`1316x960` 位图、构建和后台视觉验证已完成，开发者工具模拟器等待手动编译刷新 | requirements.md, design.md, tasks.md, execution.md |
