...
- Capture ID: `20260403-063830-secret-file-default-pipeline-local-input`
- Label: `secret-file-default-pipeline-local-input`
...
- `WECHAT_MINIAPP_APP_ID` present: `no`
- `WECHAT_MINIAPP_APP_ID` source: `missing`
- `WECHAT_MINIAPP_APP_ID` preview: `--`
- `WECHAT_MINIAPP_APP_SECRET` present: `no`
- `WECHAT_MINIAPP_APP_SECRET` source: `missing`
- `WECHAT_MINIAPP_APP_SECRET` preview: `--`
...
- current result: local machine still does not resolve a complete `WECHAT_MINIAPP_APP_ID / WECHAT_MINIAPP_APP_SECRET` input pair
