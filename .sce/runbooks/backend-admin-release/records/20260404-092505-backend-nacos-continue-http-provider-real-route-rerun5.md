...
- 配置批次号：`20260404-092505-backend-nacos-continue-http-provider-real-route-rerun5`
...
- 远端备份路径：`/opt/kaipai/backups/releases/20260404-092505-backend-nacos-continue-http-provider-real-route-rerun5/nacos-config`
- 远端归档目录：`/opt/kaipai/builds/20260404-092505-backend-nacos-continue-http-provider-real-route-rerun5`
