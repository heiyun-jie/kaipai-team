...
- 配置批次号：`20260404-061309-backend-ai-notification-config-pipeline-continue-ai-notification-remote-summary`
- 执行时间：`2026-04-04 06:13:22 +0800`
- 操作人：`codex`
...
- 诊断目录：`D:\XM\kaipai-team\.sce\runbooks\backend-admin-release\records\diagnostics\20260404-061309-continue-ai-notification-remote-summary-local-input`
- releaseReady：`否`
...
- 诊断目录：`D:\XM\kaipai-team\.sce\runbooks\backend-admin-release\records\diagnostics\20260404-061309-continue-ai-notification-remote-summary-remote-nacos`
- 目的：同步前固定目标 dataId 当前原文与目标键存在性，不再手工进控制台比对
- 预检查摘要：
  - kaipai-backend-dev.yml: missing app-id
  - kaipai-backend-dev.yml: missing app-secret
