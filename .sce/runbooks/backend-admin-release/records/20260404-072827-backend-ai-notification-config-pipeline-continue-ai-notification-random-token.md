...
- 配置批次号：`20260404-072827-backend-ai-notification-config-pipeline-continue-ai-notification-random-token`
...
- 诊断目录：`D:\XM\kaipai-team\.sce\runbooks\backend-admin-release\records\diagnostics\20260404-072827-continue-ai-notification-random-token-local-input`
- releaseReady：`是`
...
- 诊断目录：`D:\XM\kaipai-team\.sce\runbooks\backend-admin-release\records\diagnostics\20260404-072827-continue-ai-notification-random-token-remote-nacos`
...
- 记录路径：`D:\XM\kaipai-team\.sce\runbooks\backend-admin-release\records\20260404-072835-backend-nacos-continue-ai-notification-random-token.md`
- dry-run：`否`
