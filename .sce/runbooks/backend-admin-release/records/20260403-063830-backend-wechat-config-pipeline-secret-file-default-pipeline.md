...
- 配置批次号：`20260403-063830-backend-wechat-config-pipeline-secret-file-default-pipeline`
- 执行时间：`2026-04-03 06:38:30 +0800`
- 操作人：`codex`
...
- 诊断目录：`D:\XM\kaipai-team\.sce\runbooks\backend-admin-release\records\diagnostics\20260403-063830-secret-file-default-pipeline-local-input`
- releaseReady：`否`
