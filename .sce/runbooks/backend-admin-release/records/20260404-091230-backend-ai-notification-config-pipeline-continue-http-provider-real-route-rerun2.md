...
- 配置批次号：`20260404-091230-backend-ai-notification-config-pipeline-continue-http-provider-real-route-rerun2`
...
- 诊断目录：`D:\XM\kaipai-team\.sce\runbooks\backend-admin-release\records\diagnostics\20260404-091230-continue-http-provider-real-route-rerun2-local-input`
- releaseReady：`是`
...
- 诊断目录：`D:\XM\kaipai-team\.sce\runbooks\backend-admin-release\records\diagnostics\20260404-091230-continue-http-provider-real-route-rerun2-remote-nacos`
...
- 记录路径：`D:\XM\kaipai-team\.sce\runbooks\backend-admin-release\records\20260404-091240-backend-nacos-continue-http-provider-real-route-rerun2.md`
- dry-run：`否`
