...
- 配置批次号：`20260404-092002-backend-ai-notification-config-pipeline-continue-http-provider-real-route-rerun4`
- 执行时间：`2026-04-04 09:20:32 +0800`
- 操作人：`codex`
...
- 诊断目录：`D:\XM\kaipai-team\.sce\runbooks\backend-admin-release\records\diagnostics\20260404-092002-continue-http-provider-real-route-rerun4-local-input`
- releaseReady：`是`
...
- 诊断目录：`D:\XM\kaipai-team\.sce\runbooks\backend-admin-release\records\diagnostics\20260404-092002-continue-http-provider-real-route-rerun4-remote-nacos`
...
- 记录路径：`D:\XM\kaipai-team\.sce\runbooks\backend-admin-release\records\20260404-092014-backend-nacos-continue-http-provider-real-route-rerun4.md`
- dry-run：`否`
