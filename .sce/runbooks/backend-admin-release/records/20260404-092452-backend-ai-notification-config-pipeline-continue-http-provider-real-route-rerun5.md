...
- 配置批次号：`20260404-092452-backend-ai-notification-config-pipeline-continue-http-provider-real-route-rerun5`
- 执行时间：`2026-04-04 09:25:31 +0800`
- 操作人：`codex`
...
- 诊断目录：`D:\XM\kaipai-team\.sce\runbooks\backend-admin-release\records\diagnostics\20260404-092452-continue-http-provider-real-route-rerun5-local-input`
- releaseReady：`是`
...
- 诊断目录：`D:\XM\kaipai-team\.sce\runbooks\backend-admin-release\records\diagnostics\20260404-092452-continue-http-provider-real-route-rerun5-remote-nacos`
...
- 记录路径：`D:\XM\kaipai-team\.sce\runbooks\backend-admin-release\records\20260404-092505-backend-nacos-continue-http-provider-real-route-rerun5.md`
- dry-run：`否`
