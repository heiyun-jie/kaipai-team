...
- 配置批次号：`20260404-092014-backend-nacos-continue-http-provider-real-route-rerun4`
...
- 远端备份路径：`/opt/kaipai/backups/releases/20260404-092014-backend-nacos-continue-http-provider-real-route-rerun4/nacos-config`
- 远端归档目录：`/opt/kaipai/builds/20260404-092014-backend-nacos-continue-http-provider-real-route-rerun4`
